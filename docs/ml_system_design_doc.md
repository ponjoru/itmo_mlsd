...
* Подгрузка данных из облака в LabelStudio
* Формирование задачи на разметку с ТЗ и скриптами валидации разметки
* Разметка данных
* Выгрузка размеченных данных, конвертация в MOT-like формат. Деление на train/val/test по camera_id -> split маппингу
