...
**Зона события (zROI)** - zone Region of Interest полигон, задаваемый для каждой камеры вручную при установке. Зона при попадании целевого объекта, в которой \
...
* В системе должна быть подержка задания любого полигона zROI
